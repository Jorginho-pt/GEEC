...
var move_speed = 4;// Ajuste conforme necessário para aumentar ou diminuir a velocidade
var game_over = false
...
if (health <= 0) {
    health = 0;    // Garante que a vida não seja negativa
    game_over = true; // Define que o jogo acabou
}
...
if (!game_over) {
    ...
    // O jogador não pode se mover após o game over
}
