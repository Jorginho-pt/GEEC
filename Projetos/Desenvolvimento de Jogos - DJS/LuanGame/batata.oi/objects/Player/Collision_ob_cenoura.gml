...
if (!invincible) {
   if health > 0 
	levdano += 1
	health -= 10; // O personagem perde 20 pontos de vida ao colidir com o espinho
    ...
    alarm[0] = 30; // O personagem ficará invencível por 30 steps (aproximadamente 1 segundo)
}
